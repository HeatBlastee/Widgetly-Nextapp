...
const features = [
    ...
    {
        title: 'Customizable',
        description: 'Customize Widgetly to fit your needs and preferences.',
        icon: 'icon-2',
    },
    {
        title: 'Analytics',
    ...
    {
        title: 'Secure',
        description: 'Your data is safe and secure with Wexx.',
    },
    {
        title: 'Scalable',
        description: 'Grow your business with Wexx as you scale.',
    },
    {
        title: 'Fast Support',
